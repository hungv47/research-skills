...
short-form-research → .agents/skill-artifacts/research/short-form-research/[slug].md (consumed by short-form-brief in marketing-skills)
...
- `.agents/skill-artifacts/research/short-form-research/[slug].md` (per-platform best-practice catalog — pipeline output, consumed by short-form-brief)
...
All 7 non-orchestrator skills use a two-layer multi-agent orchestration pattern:
