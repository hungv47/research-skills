...
2. **Existing artifacts** — Read `.agents/skill-artifacts/meta/records/diagnose-*.md` and `.agents/skill-artifacts/meta/sketches/prioritize-*.md` for numbers already established.
