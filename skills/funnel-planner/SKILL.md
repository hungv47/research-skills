...
routing:
  ...
  lifecycle: snapshot
  produces:
    - skill-artifacts/meta/records/targets-*.md
  consumes:
    - product-context.md
...
This skill is **hard-gated** on `.agents/skill-artifacts/meta/sketches/prioritize-*.md`. No cold-start questioning — prioritize is the upstream that produces the ranked initiatives this skill sets targets for. Full Pre-Dispatch pattern: `meta-skills/references/pre-dispatch-protocol.md`.
